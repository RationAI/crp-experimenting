...
class AttentionAttribution(CondAttribution):
    ...
    def __init__(self, model: torch.nn.Module, device: torch.device = None, 
                 overwrite_data_grad=True, no_param_grad=True):
        """
    ...
    def __call__(
            ...
            start_layer: str = None, init_rel=None,
            on_device: str = None, exclude_parallel=True) -> attrResult:
        """
        ...
        return super().__call__(data, conditions, composite, record_layer,
                               mask_map, start_layer, init_rel, on_device, exclude_parallel)
    ...
    def generate(
            ...
            mask_map: Union[Callable, Dict[str, Callable]] = None, 
            start_layer: str = None, init_rel=None,
            on_device=None, exclude_parallel=True, verbose=True) -> attrResult:
        """
        ...
        return super().generate(data, conditions, composite, record_layer,
                               mask_map, start_layer, init_rel, on_device,
                               exclude_parallel, verbose)
